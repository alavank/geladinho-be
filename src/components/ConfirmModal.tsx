...
export default function ConfirmModal({ formData, cartItems, totalUnits, subtotalCents, freightCents, grandTotalCents, onConfirm, onBack, submitting, error }: Props) {
  const address = [
        ...
        <dl className="space-y-2 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <dd className="font-semibold text-gray-900">
              {formData.needsChange ? `Sim — tem € ${formData.changeAmount} em mãos` : 'Não precisa'}
            </dd>
          </div>

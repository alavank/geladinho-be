...
export default function ParametrosPage() {
  ...
  const isActiveModule = useIsAdminModuleActive('/gestion/parametros');
  ...
  const handleAddCategory = async () => {
    ...
    const response = await fetch('/api/gestion/expense-categories', {
      method: 'POST',
  ...
  const handleUpdateCategory = async (id: string) => {
    const response = await fetch(`/api/gestion/expense-categories/${id}`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
  ...
  const handleToggleCategory = async (category: ExpenseCategory) => {
    await fetch(`/api/gestion/expense-categories/${category.id}`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeleteCategory = async (category: ExpenseCategory) => {
    ...
    const response = await fetch(`/api/gestion/expense-categories/${category.id}`, {
      method: 'DELETE',
    });
  ...
  const handleUpdateStatus = async (key: string) => {
    const response = await fetch(`/api/gestion/order-statuses/${key}`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
  ...
  const handleAddStatus = async () => {
    ...
    const response = await fetch('/api/gestion/order-statuses', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeleteStatus = async (config: OrderStatusConfig) => {
    ...
    const response = await fetch(`/api/gestion/order-statuses/${config.key}`, {
      method: 'DELETE',
    });
  ...
  const handleToggleStatus = async (config: OrderStatusConfig) => {
    await fetch(`/api/gestion/order-statuses/${config.key}`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
